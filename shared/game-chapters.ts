...
export const GAME_CHAPTERS: GameChapter[] = [
  {
    ...
    nodePositions: [
      { id: 'ch1-01', x: 0.12, y: 0.76 },
      { id: 'ch1-02', x: 0.2, y: 0.69 },
      { id: 'ch1-03', x: 0.29, y: 0.63 },
      { id: 'ch1-04', x: 0.38, y: 0.58 },
      { id: 'ch1-05', x: 0.47, y: 0.53 },
      { id: 'ch1-06', x: 0.56, y: 0.5 },
      { id: 'ch1-07', x: 0.64, y: 0.46 },
      { id: 'ch1-08', x: 0.72, y: 0.43 },
      { id: 'ch1-09', x: 0.78, y: 0.36 },
      { id: 'ch1-10', x: 0.83, y: 0.29 },
      { id: 'ch1-11', x: 0.88, y: 0.22 },
      { id: 'ch1-12', x: 0.92, y: 0.15 },
    ],
    levelPlan: [
  ...
  },
  {
    ...
    storyKeywords: '算法纸条、二进制冰灯、补码冰纹、位灯开关、雪灯巡查、冰牌文字、风雪模拟',
    titleExamples: ['纸条译者', '位灯巡使', '雪灯记官', '枚举哨兵'],
    mapAsset: '/assets/art/backgrounds/ch3-sorting-icefield/main-map-v2.png',
    nodePositions: [
      { id: 'ch3-01', x: 0.089, y: 0.794 },
      { id: 'ch3-02', x: 0.24, y: 0.7 },
      { id: 'ch3-03', x: 0.365, y: 0.622 },
      { id: 'ch3-04', x: 0.491, y: 0.676 },
      { id: 'ch3-05', x: 0.629, y: 0.621 },
      { id: 'ch3-06', x: 0.716, y: 0.52 },
      { id: 'ch3-07', x: 0.666, y: 0.371 },
      { id: 'ch3-08', x: 0.769, y: 0.284 },
      { id: 'ch3-09', x: 0.839, y: 0.207 },
      { id: 'ch3-10', x: 0.504, y: 0.449 },
      { id: 'ch3-11', x: 0.733, y: 0.787 },
      { id: 'ch3-12', x: 0.861, y: 0.866 },
      { id: 'ch3-13', x: 0.915, y: 0.121 },
    ],
    routeSegments: [
      ['ch3-01', 'ch3-02'],
      ['ch3-02', 'ch3-03'],
    ...
    levelPlan: [
      ...
      { id: 'ch3-02', title: '二进制冰灯', knowledgePoint: '进制转换', storyNode: '把冰灯明暗记录在十进制和二进制之间互转。' },
      { id: 'ch3-03', title: '补码冰纹', knowledgePoint: '原码、反码、补码', storyNode: '读懂负温冰纹在机器里的真实表示。' },
      { id: 'ch3-04', title: '位灯开关', knowledgePoint: '位运算 AND/OR/XOR/NOT', storyNode: '用位运算控制一排雪灯的开关状态。' },
      { id: 'ch3-05', title: '雪盘移位', knowledgePoint: '左移与右移', storyNode: '让雪盘编号按二倍或半数规则移动。' },
      { id: 'ch3-06', title: '雪灯巡查', knowledgePoint: '一维数组遍历', storyNode: '按顺序检查一排雪灯是否仍然发热。' },
      { id: 'ch3-07', title: '最冷雪灯', knowledgePoint: '数组统计：最大值、最小值、计数、求和', storyNode: '从热值记录中找出最危险的低温段。' },
  ...
  },
  {
    ...
    nodePositions: [
      ...
      { id: 'ch4-03', x: 0.29, y: 0.6 },
      { id: 'ch4-04', x: 0.4, y: 0.53 },
      { id: 'ch4-05', x: 0.51, y: 0.46 },
      { id: 'ch4-06', x: 0.62, y: 0.39 },
      { id: 'ch4-07', x: 0.71, y: 0.49 },
      { id: 'ch4-08', x: 0.78, y: 0.62 },
      { id: 'ch4-09', x: 0.86, y: 0.73 },
      { id: 'ch4-10', x: 0.73, y: 0.29 },
      { id: 'ch4-11', x: 0.82, y: 0.22 },
      { id: 'ch4-12', x: 0.88, y: 0.15 },
      { id: 'ch4-13', x: 0.92, y: 0.09 },
    ],
    routeSegments: [
      ['ch4-01', 'ch4-02', 'ch4-03', 'ch4-04', 'ch4-05', 'ch4-06', 'ch4-10', 'ch4-11', 'ch4-12', 'ch4-13'],
      ['ch4-06', 'ch4-07', 'ch4-08', 'ch4-09'],
      ['ch4-09', 'ch4-13'],
    ],
    levelPlan: [
      ...
      { id: 'ch4-11', title: '风暴估时', knowledgePoint: '简单时间复杂度估算', storyNode: '判断算法能否在风暴抵达前跑完。' },
      { id: 'ch4-12', title: '冰原日志读写', knowledgePoint: '文件读写', storyNode: '把巡查结果写入日志，再从日志中复核。' },
      { id: 'ch4-13', title: '寒霜冰桥', knowledgePoint: '递推、函数、基础排序、文件读写综合', storyNode: '选择合适基础算法，稳定通过寒霜的冰桥。' },
    ],
  },
  {
