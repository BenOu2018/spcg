...
import { SUPPORTED_UI_LOCALES, getStudentUiMessages } from '@/lib/student-ui'

type SettingsPageProps = {
  searchParams?:
    | Promise<{ tab?: string; profile?: string; password?: string; phone?: string; phoneNumber?: string; devCode?: string; language?: string }>
    | { tab?: string; profile?: string; password?: string; phone?: string; phoneNumber?: string; devCode?: string; language?: string }
}
        ...
        <section className="settings-tab-content">
          ...
          <section className="settings-panel">
            ...
            <div className="settings-session-card">
              ...
              <strong>
                {parentInvite?.studentPhoneNumberMasked ??
                  phone.phoneNumberMasked ??
                  messages.settings.phoneUnbound}
            ...
            {!parentInvite?.studentPhoneNumberMasked && !phone.phoneNumberMasked ? (
              <Link className="settings-inline-link" href="/settings?tab=phone">
