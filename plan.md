...
- **SPCG 1 级 12 关**完整教学内容（题面 + 测试用例 + 童化错误反馈）
- **题库核心结构**：每题 difficulty + 20 个标准测试样例 + 三步提示 + AC 后题解/题解视频链接 + 官方 AC 代码
...
Week 1：地基
  ...
  05-内容  ████░░    题目模板定 + 第 1 关老师亲写（20 cases / hints / solution / official code）
